            ...
            <tbody>
              {ownersWithBreakdown.map((o: Record<string, any>) => (
                <>
                      ...
                      {i === 0 && (
                        <td className="px-5 py-2.5 font-medium" rowSpan={o.propertyBreakdown.length + 1}>
                          <div className="flex items-center gap-2">
                            ...
                            <div>
                              <div>{o.name}</div>
                              <div className="text-[10px] text-text-muted font-normal">手数料 {Number(o.management_fee_rate)}%</div>
                            </div>
                          </div>
                        </td>
                      )}
                      <td className="px-5 py-2.5 text-text-secondary">{p.propertyName}</td>
                  ...
                  <tr key={`${o.id}-total`} className="bg-bg-secondary/30 font-medium border-b border-border">
                    <td className="px-5 py-2 text-right text-text-muted text-[11px]" colSpan={2}>合計</td>
