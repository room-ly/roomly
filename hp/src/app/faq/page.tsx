...
const faqCategories = [
  ...
  },
  {
    ...
    questions: [
      ...
      {
        q: "有料プランの料金はいくらですか？",
        a: "区画数に応じた従量制です。〜50区画 ¥5,000（税込）/月、〜100区画 ¥10,000（税込）/月、〜300区画 ¥15,000（税込）/月、〜500区画 ¥20,000（税込）/月、〜1,000区画 ¥25,000（税込）/月、〜2,000区画 ¥30,000（税込）/月。2,000区画超は個別にお見積りいたします。全プランで全機能が利用可能です。",
      },
      {
        q: "初期費用はかかりますか？",
        a: "いいえ。初期費用は一切かかりません。",
