...
type ServiceType = "collection" | "standard" | "full";
...
export default function ManagementFeeCalculator() {
  ...
  const result = useMemo(() => {
    ...
    const monthlyFeeMin = monthlyRevenue * selected.rateMin;
    const monthlyFeeMax = monthlyRevenue * selected.rateMax;
    const annualFeeMin = monthlyFeeMin * 12;
    const annualFeeMax = monthlyFeeMax * 12;
    return {
      monthlyRevenue,
      monthlyFeeMin,
      monthlyFeeMax,
