      ...
      <div className="mx-auto max-w-3xl">
        ...
        <div className="prose-rm mt-10">
          ...
          <ul>
            ...
            <li>本サービスの使い方案内、新機能・アップデート情報、活用Tips、キャンペーン情報、関連サービスのご案内などのメール配信</li>
          </ul>

          <p>上記のメール配信は、利用者が本サービスにアカウントを登録した時点で同意したものとみなします。配信を希望されない場合は、各メール末尾の配信停止リンクまたはお問い合わせフォームよりお申し出ください。なお、サービス運営上必要不可欠な通知（重要なお知らせ、契約・請求関連、セキュリティに関する通知等）は配信停止の対象外となります。</p>
