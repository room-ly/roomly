    ...
    <>
      ...
      <div className="cols-summary" style={{ marginBottom: 24 }}>
        <div className="sum-card">
          <span className="sum-label mono">構造</span>
        ...
        <div className="sum-card">
          <span className="sum-label mono">築年</span>
          <span className="sum-value" style={{ fontSize: 16 }}>
        ...
        <div className="sum-card">
          ...
          <span className="sum-value serif-i">{occupancyPct}%</span>
          <span className="sum-foot mono">{occupied}/{units.length}戸</span>
        </div>
        <div className="sum-card">
          <span className="sum-label mono">オーナー</span>
          <span className="sum-value" style={{ fontSize: 16 }}>
            {property.owner?.name ? (
