...
const ALL_PAGES: SearchItem[] = [
  ...
  { kind: "page", label: "修繕", route: "/maintenance", sub: "Operations", keywords: "修繕 maintenance operations" },
  { kind: "page", label: "経費", route: "/expenses", sub: "Operations", keywords: "経費 expenses operations" },
  { kind: "page", label: "問い合わせ", route: "/inquiries", sub: "Operations", keywords: "問い合わせ inquiries operations" },
